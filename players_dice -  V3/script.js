...
function movePlayer(player, steps) {
    ...
    const currentCell = document.getElementById(`casilla-${currentPos}`);
    const newCell = document.getElementById(`casilla-${player === 1 ? posP1 : posP2}`);
